...
//      begin_show();
    ...
    volumn_change();  //PCB上增加AI32C作为触摸按键来控制音量的+-
		...
		// 按下左摇杆开始游戏(后续PCB时更改为此方式启动游戏)
//        if(((IO_READ->IO_MODE_READ)&0X08)!=0x08)  
//        {
//            //delay_ms(10);
//            if(((IO_READ->IO_MODE_READ)&0X08)!=0x08) 
//            {
...
//				default: game_mode=0; IO->IO_MODE[7]=1;IO->IO_MODE[6]=0; IO->IO_MODE[5]=0;
	...
	start_char[0]='P';
	over_char[0]='G';
	score_over_char[11]=score/10+'0';
	score_over_char[12]=score%10+'0';
